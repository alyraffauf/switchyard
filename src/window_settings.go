...
func createSidebar(win *adw.Window, cfg *Config, browsers []*Browser, splitView *adw.NavigationSplitView) gtk.Widgetter {
	...
	appearanceIcon := gtk.NewImageFromIconName("applications-graphics-symbolic")
	...
	rulesIcon := gtk.NewImageFromIconName("view-list-symbolic")
	...
	advancedIcon := gtk.NewImageFromIconName("preferences-other-symbolic")
